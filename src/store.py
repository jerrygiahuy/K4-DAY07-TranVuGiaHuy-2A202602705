...
class EmbeddingStore:
    ...
    def __init__(
        ...
        # The lab deliberately uses one deterministic in-memory implementation.
        # This avoids changing behaviour merely because chromadb happens to be
        # installed on the machine running the submission.
